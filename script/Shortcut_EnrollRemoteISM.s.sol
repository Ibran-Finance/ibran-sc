 ...
 * 
 * This script is similar to Shortcut_CreateLP.s.sol but specifically focused on the
 * Base Sepolia and Etherlink testnet chain pair.
 * 
...
contract ShortcutEnrollRemoteISM is Script {
     ...
     * function with the appropriate parameters for each chain. The router and ISM addresses
     * are converted to bytes32 format as required by the interface.
     */
    function run() public {
