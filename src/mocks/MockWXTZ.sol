...
/**
 * @title MockWXTZ
 * @dev Mock implementation of WXTZ token with bridge functionality for testing purposes
 * @notice This contract mimics WXTZ behavior with additional features for cross-chain bridge testing
 * @author IBRAN Team
 */
contract MockWXTZ is ERC20 {
    ...
    /**
     * @dev Constructor to initialize the MockWXTZ contract
     ...
     * @dev WXTZ uses 6 decimal places
