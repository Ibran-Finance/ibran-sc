...
/**
 * @title MockUSDC
 * @dev Mock implementation of USDC token with bridge functionality for testing purposes
 * @notice This contract mimics USDC behavior with additional features for cross-chain bridge testing
 * @author IBRAN Team
 */
contract MockUSDC is ERC20 {
    ...
    /**
     * @dev Constructor to initialize the MockUSDC contract
     ...
     * @dev USDC uses 6 decimal places
