...
/**
 * @title MockWETH
 * @dev Mock implementation of WETH token with bridge functionality for testing purposes
 * @notice This contract mimics WETH behavior with additional features for cross-chain bridge testing
 * @author IBRAN Team
 */
contract MockWETH is ERC20 {
    ...
    /**
     * @dev Constructor to initialize the MockWETH contract
     * @param _helperTestnet Address of the helper testnet contract
     */
    constructor(address _helperTestnet) ERC20("Wrapped Ether", "WETH") {
     ...
     * @dev WETH uses 18 decimal places
