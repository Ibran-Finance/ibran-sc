...
/**
 * @title MockWBTC
 * @dev Mock implementation of WBTC token with bridge functionality for testing purposes
 * @notice This contract mimics WBTC behavior with additional features for cross-chain bridge testing
 * @author IBRAN Team
 */
contract MockWBTC is ERC20 {
    ...
    /**
     * @dev Constructor to initialize the MockWBTC contract
     ...
     * @dev WBTC uses 8 decimal places
     * @return Number of decimal places (8)
     */
